...
public class ElasticsearchService {
    ...
    public static List<String> getSuggestion(String input) throws IOException {
        ...
        SuggestionBuilder termSuggestionBuilder = SuggestBuilders.completionSuggestion("suggest").text(input).skipDuplicates( true ).size(10);
        ...
        SearchRequest searchRequest = new SearchRequest("huylq78_suggest");
